    ...
    <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex flex-col items-start gap-2">
          ...
          <AiAssistantInfo
            label="AI-assisted"
            shortExplanation="Generated by AI using your goal and profile."
            explanation="This learning path is generated by an AI system based on your goal and profile information. It may reflect biases present in training data or source materials. If you notice content that seems biased, culturally insensitive, or inappropriate, report it so we can improve."
