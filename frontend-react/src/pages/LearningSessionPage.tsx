      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-white border-r border-slate-200">
        ...
        <div ref={contentRef} className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl border border-slate-200 bg-slate-50">
            <button
              type="button"
              className="w-12 h-12 rounded-full bg-slate-800 text-white flex items-center justify-center shrink-0 hover:bg-slate-700 transition-colors"
              aria-label="Play"
            >
        ...
        <div className="shrink-0 p-3 border-t border-slate-200">
          ...
          >
            ...
            <button
              ...
              className="w-8 h-8 rounded-lg bg-slate-800 text-white flex items-center justify-center hover:bg-slate-700 disabled:opacity-40 shrink-0"
              aria-label="Send"
            >
